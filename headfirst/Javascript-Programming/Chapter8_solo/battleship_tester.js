...
function parseGuess(guess) {
    ...
    if (guess === null || guess.length !== 2) {
        ...
        var row = alphabet.indexOf(guess.charAt(0));  // chaining
...
/*
console.log(parseGuess("A0"));  // miss

console.log(parseGuess("A6"));  // hit
console.log(parseGuess("B6"));  // hit
console.log(parseGuess("C6"));  // hit

console.log(parseGuess("C4"));  // hit
console.log(parseGuess("D4"));  // hit
console.log(parseGuess("E4"));  // hit

console.log(parseGuess("B0"));  // hit
console.log(parseGuess("B1"));  // hit
console.log(parseGuess("B2"));  // hit
*/