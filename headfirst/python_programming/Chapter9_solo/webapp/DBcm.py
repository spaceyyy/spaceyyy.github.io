#!python3
# DBcm.py - Class turned into a module for webapp file

"""The UseDatabase context manager for working with MySQL/MariaDB.

For more info, see Ch. 7, 8, 9, and 11 of the 2nd edition of Head
First Python.
...
Enjoy, and have fun. (Sorry: Py -3 only, due to type hints and new syntax).
"""
