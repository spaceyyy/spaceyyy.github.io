#!python3
# new_DBcm.py - Class turned into a module for webapp file containing
#               `try/except` statements.


"""The UseDatabase context manager for working with MySQL/MariaDB.

For more information, see Chapters 7, 8, 9, and all 11 of the HFP2ed.
...
class CredentialsError(Exception):
    """Raised if the databse is up, but there's a login issue."""
    pass
