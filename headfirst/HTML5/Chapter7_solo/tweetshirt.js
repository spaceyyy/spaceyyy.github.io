...
// creating an image from your design and ready to upload to a site that will
// print an image on a t-shirt for you
// Easter Egg
function makeImage() {
  var canvas = document.getElementById("tshirtCanvas");
...
// hosted server if you want it to work across all browsers.
